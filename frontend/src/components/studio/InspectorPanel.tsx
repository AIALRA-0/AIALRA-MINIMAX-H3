...
const INSPECTOR_TABS = [
  { id: "generate" as const, labelKey: "inspector.generate", icon: Sparkles },
  { id: "shot" as const, labelKey: "inspector.shot", icon: Clapperboard },
  { id: "camera" as const, labelKey: "inspector.camera", icon: Camera },
  { id: "audio" as const, labelKey: "inspector.audio", icon: Mic },
];
      ...
      <div className="flex-1 overflow-y-auto min-h-0">
        ...
        {activeInspector === "shot" && !selectedShot && (
          <div className="flex flex-col items-center justify-center h-full gap-2 text-center px-4">
            ...
            <p className="text-xs text-studio-muted">{t("inspector.selectShot")}</p>
          </div>
        )}
